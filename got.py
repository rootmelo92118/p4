...
botStart = time.time()
#==============================================================================#
line = LINE("EttfAEszm0a3a3zhES57.AUAqwFtBKzZ988ErzkN6HW.oo9ZQLyqpCj69juybLjdICWeCXjsJnequVx2Q2Yhx2s=")
...
RfuBot=[lineMID]
Family=["u6ae69059f4db919cfdf3c79164a9fa87",lineMID]
admin=['u6ae69059f4db919cfdf3c79164a9fa87',lineMID]
...
settings = {
    ...
    "cName":"",
    "cNames":"",
    "welcome":"💜ยินดีต้อนรับ🤩\n💜เข้ามาแล้วอย่าดื้อน้า\n👉สนใจบอทติดต่อเรา🤣\nhttp://line.me/ti/p/~likhit..nalux",
    "bye":"💘 บ๊ายบาย..💕\n😍แล้วพบกันใหม่💟",
    "invite": {},
    "winvite": False,
    "pnharfbot": {},
    "pname": {},
    "pro_name": {},
    "message":"Thanks for add me ✮ ғc.ᴘ'ʟɪкɪнт тᴇѕт вот ✮",
    "comment":"Thanks for add me ✮ ғc.ᴘ'ʟɪкɪнт тᴇѕт вот ✮",
...
#==============================================================================#
                    ...
                    start = time.time()
                    line.sendMessage(to, "   ✮ ғc.ᴘ'ʟɪкɪнт вот ✮")
                    elapsed_time = time.time() - start
                    line.sendMessage(to,format(str(elapsed_time)))	
                elif text.lower() == 'Sp':
                    start = time.time()
                    line.sendMessage(to, "   😃แรงขนาดนี้ขี้ใส่นาให้แน")
                    elapsed_time = time.time() - start
                    line.sendMessage(to,format(str(elapsed_time)))						
...
#                    line.sendMessage(to, "Success Restarting.")
                    ...
                    line.sendMessage(to, "💞เวลาการนอนของบอท😂 {}".format(str(runtime)))
...
#==============================================================================#
                    ...
                    line.sendMessage(msg.to,"ชื่อ ✪ " + me.displayName)
                elif text.lower() == 'ตัส':
                    me = line.getContact(lineMID)
...
#===================================================================#              
                    ...
                    msg.contentMetadata={'PRDID': '',
                                        ...
                                        'MSGTPL': '1'}
                    msg.text = None
                    line.sendMessage(msg.to,text = None,contentMetadata={'PRDID': '','PRDTYPE': 'THEME','MSGTPL': '1'},contentType = 9)
                  ...
                  if msg._from in admin:
                     ...
                     if spl in [""," ","\n",None]:
                         ...
                         line.sendMessage(msg.to, "✮ ғc.ᴘ'ʟɪкɪнт вот ✮️\n\n{}".format(str(spl)))
                  ...
                  if msg._from in admin:
                     ...
                     if spl in [""," ","\n",None]:
                         line.sendMessage(msg.to, "ตั้งข้อความคนออกเรียบร้อย")
                          ...
                          settings["bye"] = spl
                          line.sendMessage(msg.to, "✮ ғc.ᴘ'ʟɪкɪнт вот ✮\n\n\n{}".format(str(spl)))
